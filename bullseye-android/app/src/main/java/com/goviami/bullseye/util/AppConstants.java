...
/**
 * Created by subbu on 11/8/2014.
 */
public final class AppConstants {
    public static final String SHARED_PREF_NAME = "com.goviami.bullseye.dartmsg.PREF_FILE_ACTIVITY";
    ...
    public static final int HOME_ACTIVITY_KEY = 3;
